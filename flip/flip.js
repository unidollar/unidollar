...
var address = '0xB836FB4234A37b4A0539EC7A8625b424F08966ea';
...
var tokenAddress = '0x256845e721c0c46d54e6afbd4fa3b52cb72353ea';
var UNIUSD = web3.eth.contract(tokenAbi).at(tokenAddress);
	...
	Cards.allCardsInfo.call(function(error, data) {
		if (!error) {
          ...
          <img class="flag" src="https://unidollar.network/flip/icons/${cardData[i].code}.png" alt="">
                ...
                <a class="btn btn-xs buyCard btn-soft-red-text transition-3d-hover btn-block mt-2 text-uppercase font-weight-semi-bold lh-sm" href="">Flip This For<br /> <small>${formatNumber(
									card.price,
									5
								)} UNIUSD</small></a>
              </div>
